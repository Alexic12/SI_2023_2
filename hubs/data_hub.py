...
class Data:
    ...
    def data_process(self, file, test_split, norm, neuron,avoid_col):
        ...
        ##Lets convert the raw to an array
        ...
        data_features = data_arr[:,avoid_col:-neuron]
        data_labels = data_arr[:, -neuron:]
        ...
        ##inpit (train, test) output(train,test)
        if test_split != 0:
