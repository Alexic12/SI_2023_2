...
class Perceptron:
    ...
    def run(self, train_features, test_features, train_labels, test_labels, iter, alfa, stop_condition):
        ...
        Wij = np.zeros((hidden_neurons.shape[1], train_features.shape[1])) #Matriz de pesos first layer las filas se hacen con la cantidad de neuras ocultas y las columnas son los datos de entrada(features)
