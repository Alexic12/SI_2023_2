...
class Perceptron:
    ...
    def run(self,train_features, test_features, train_labels, test_labels, iter,alfa, stop_condition, neuron):
        ...
        ecmT= np.zeros((train_labels.shape[1],iter)) # ECM results for each iteration
