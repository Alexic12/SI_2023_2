...
class Data:
    ...
    def timeseries_process_adapt(self, window_size, horizon_size, file, test_split, norm):
        ...
        ##Rows = (#Sample Times - Window - horizon)
        ##Columns = (window + horizon)
        time_series_arr = np.zeros((data_length - window_size - horizon_size + 1, window_size*4 + horizon_size + 3)) # En columnas se poner por cuatro porque hay 4 filas en la data
