...
class MassDamper:
    ...
    def run_simulation(self):
        ...
        for i in range(1, len(t)):
            ...
            self.U = self.inverse_neuronal_control(control_vector)*0.8
        ...
        ##Aca se sacan los datos del sistema masa-resorte
        """
        ...
        excel_filename = 'Toma_de_datos.xlsx'
